            ...
            itemBuilder: (context) => <PopupMenuEntry<String>>[
              ...
              PopupMenuItem(
                ...
                child: ListTile(
                  ...
                  ? Icons.lock_outline : Icons.check_circle_outline_rounded),
              )),
            ],
            onSelected: (val) {
              ...
              switch (val) {
                ...
                case 'copy_phone_number':
                 ...
                 _copyText(context, text: user.userPhoneNumber, 
                      ...
                      await AppModel().updateUserData(
                       ...
                       data: {USER_STATUS: newStatus}
                        ...
                        showScaffoldMessage(
                          context: context,
                          scaffoldkey: _scaffoldKey,
                          message: "Error while updating profile status.\nPlease try again later!");
                      });
        ...
        child: Column(
            ...
            children: [
              ...
              Container(
                ...
                height: 445, color: Theme.of(context).primaryColor,
                child: Column(
                  ...
                  children: [
                    ...
                    // Full name
                    SizedBox(height: 10),
                    Text(user.userFullname, style: TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("Profile Gallery", style: TextStyle(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        size: 100),
                        SizedBox(height: 10),
                        Text("Gallery empty",style: TextStyle(
                          color: Colors.grey, fontSize: 18), 
              ...
              ListTile(
                ...
                trailing: Text(AppModel().formatDate(user.userRegDate)), // Date Format: year/month/day
              ), 
              Divider(thickness: 1),  
            ...
            // User ID 
              ...
              ListTile(
                ...
                subtitle: Text('User is verified automatically when subscribe to VIP account'),
                trailing: UserStatus(status: 
                user.userIsVerified ? 'verified': 'Not verified'),
              ), 
              Divider(thickness: 1),  
              SizedBox(height: 30), 
            ],
