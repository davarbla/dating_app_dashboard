...
class AppModel extends Model {
  ...
  void saveAppSettings({
    @required int appCurrentVersion,
    ...
    updateAppData(data: {
      ...
      FREE_ACCOUNT_MAX_DISTANCE: freeAccountMaxDistance,
      VIP_ACCOUNT_MAX_DISTANCE: vipAccountMaxDistance,
      // Admob variables
      ADMOB_APP_ID: adMobAppId,
      ADMOB_INTERSTITIAL_AD_ID: adMobInterstitialAdId, 
